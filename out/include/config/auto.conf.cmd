deps_config := \
	...
	drivers/staging/ktrace/Kconfig \
	drivers/staging/rtmm/Kconfig \
	...
	drivers/input/touchscreen/focaltouch/Kconfig \
...
ifneq "$(CC_VERSION_TEXT)" "real-aarch64-linux-android-gcc (GCC) 4.9.x 20150123 (prerelease)"
include/config/auto.conf: FORCE
endif
ifneq "$(srctree)" ".."
include/config/auto.conf: FORCE
endif
ifneq "$(CC)" "python ../scripts/gcc-wrapper.py /mnt/case_sensitive/aarch64-linux-android-4.9/bin/aarch64-linux-android-gcc"
include/config/auto.conf: FORCE
endif
ifneq "$(LD)" "/mnt/case_sensitive/aarch64-linux-android-4.9/bin/aarch64-linux-android-ld"
include/config/auto.conf: FORCE
endif
ifneq "$(SRCARCH)" "arm64"
include/config/auto.conf: FORCE
